"""Tests for the interactive session browser (`bitidea sessions browse`).
...
from bitidea_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """bitidea sessions browse should be parseable."""
        from bitidea_cli.main import main as _main_entry
