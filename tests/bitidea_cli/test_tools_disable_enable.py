"""Tests for bitidea tools disable/enable/list command (backend)."""
from argparse import Namespace
from unittest.mock import patch

from bitidea_cli.tools_config import tools_disable_enable_command
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("bitidea_cli.tools_config.load_config", return_value=config), \
             patch("bitidea_cli.tools_config.save_config") as mock_save:
