...
def test_sessions_delete_accepts_unique_id_prefix(monkeypatch, capsys):
    import bitidea_cli.main as main_mod
    import bitidea_state
    ...
    monkeypatch.setattr(bitidea_state, "SessionDB", lambda: FakeDB())
    monkeypatch.setattr(
        sys,
        "argv",
        ["bitidea", "sessions", "delete", "20260315_092437_c9a6", "--yes"],
    )
...
def test_sessions_delete_reports_not_found_when_prefix_is_unknown(monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["bitidea", "sessions", "delete", "missing-prefix", "--yes"],
    )
...
def test_sessions_delete_handles_eoferror_on_confirm(monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        sys, "argv",
        ["bitidea", "sessions", "delete", "20260315_092437_c9a6"],
    )
