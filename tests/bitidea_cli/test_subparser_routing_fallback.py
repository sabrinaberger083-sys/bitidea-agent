...
The main() function in bitidea_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `bitidea -c model`
...
def _build_parser():
    """Build a minimal replica of the bitidea top-level parser."""
...
class TestSubparserRoutingFallback:
    ...
    def test_bare_bitidea_defaults_to_none(self):
        parser, sub = _build_parser()
