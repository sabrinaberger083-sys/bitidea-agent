...
def test_import_loads_env_from_bitidea_home(tmp_path, monkeypatch):
    home = tmp_path / ".bitidea"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-bitidea-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-bitidea-home"
