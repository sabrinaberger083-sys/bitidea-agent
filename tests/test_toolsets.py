...
class TestToolsetConsistency:
    ...
    def test_bitidea_platforms_share_core_tools(self):
        """All bitidea-* platform toolsets should have the same tools."""
        platforms = ["bitidea-cli", "bitidea-telegram", "bitidea-discord", "bitidea-whatsapp", "bitidea-slack", "bitidea-signal", "bitidea-homeassistant"]
