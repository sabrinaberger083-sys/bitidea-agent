...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("bitidea_cli.config.get_config_path", return_value=config_path), \
             patch("bitidea_cli.config.ensure_bitidea_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("bitidea_cli.config.get_env_path", return_value=env_path), \
             patch("bitidea_cli.config.ensure_bitidea_home"):
    ...
    def test_ensure_bitidea_home_sets_0700(self):
        home = Path(self.tmpdir) / ".bitidea"
        with patch("bitidea_cli.config.get_bitidea_home", return_value=home):
