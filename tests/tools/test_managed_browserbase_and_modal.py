...
def _enable_managed_nous_tools(monkeypatch):
    ...
    bitidea_cli.auth and bitidea_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("bitidea_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("bitidea_cli.models.check_nous_free_tier", lambda: False)
