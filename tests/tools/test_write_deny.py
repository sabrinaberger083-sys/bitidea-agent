...
class TestWriteDenyExactPaths:
    ...
    def test_bitidea_env(self):
        path = os.path.join(str(Path.home()), ".bitidea", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_bitidea_config_not_env(self):
        path = os.path.join(str(Path.home()), ".bitidea", "config.yaml")
