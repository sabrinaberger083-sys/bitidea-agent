...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_bitidea_home_override(self, tmp_path):
        """Auth lookup should read from BITIDEA_HOME/auth.json, not ~/.bitidea/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".bitidea").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``bitidea tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
