"""Integration tests for BitideaAgentLoop with a local vLLM server.
...
try:
    from environments.agent_loop import AgentResult, BitideaAgentLoop
except ImportError:
...
def _make_server_manager():
    ...
    sm = ServerManager([config], tool_parser="bitidea")
