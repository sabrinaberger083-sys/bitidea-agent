...
def _reload_constants():
    """Reload bitidea_constants to get a fresh apply_ipv4_preference."""
    import bitidea_constants
    importlib.reload(bitidea_constants)
    return bitidea_constants
...
class TestApplyIPv4Preference:
    ...
    def test_noop_when_force_false(self):
        ...
        from bitidea_constants import apply_ipv4_preference
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_bitidea_ipv4_patched", False) is True
